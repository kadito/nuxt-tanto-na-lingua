import { getCurrentInstance, version, inject, useSSRContext, shallowRef, computed, reactive, isReadonly, defineComponent, createApp, toRef, isRef, nextTick, ref, mergeProps, unref, h, Suspense, Transition, provide, createVNode, resolveDynamicComponent, onErrorCaptured, onServerPrefetch, defineAsyncComponent } from 'vue';
...
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderVNode, ssrRenderSuspense } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_firstname_-_lastname_-30b174f0.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a5c4a418.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-612dabe2.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-a6b39d81.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useRouter as a, useNuxtApp as b, createError as c, entry$1 as default, navigateTo as n, useRoute as u };
