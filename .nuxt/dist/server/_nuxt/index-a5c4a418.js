...
const AboutUs_vue_vue_type_style_index_0_scoped_e79261f7_lang = "";
const _sfc_main$3 = {
  __name: "AboutUs",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative isolate overflow-hidden py-20 about-us" }, _attrs))} data-v-e79261f7><div class="mx-auto max-w-7xl px-6 lg:px-8" data-v-e79261f7><div class="mx-auto max-w-4xl lg:mx-0" data-v-e79261f7><h2 class="text-4xl font-bold tracking-tight sm:text-6xl title" data-v-e79261f7>Sobre nós</h2><p class="mt-6 text-lg leading-8 text" data-v-e79261f7>A Tanto na Língua, criada em 2019, possui os serviços de terapia da fala, ensino especializado, psicomotricidade, psicologia educacional, psicologia clínica, terapia ocupacional, musicoterapia, fisioterapia, tutorias e classes de estimulação global. Este projecto surgiu da vontade de maximizar o desenvolvimento global de cada criança, priorizando o trabalho em equipa, centrado na criança e ir de encontro ao ambiente mais natural da criança sem descurar o papel crucial da família e dos professores/educadores nesta evolução. Mais tarde, alargamos e especializamos os nossos serviços para um atendimento especializado à população adulta.</p></div><div class="mx-auto mt-8 max-w-2xl lg:mx-0 lg:max-w-none" data-v-e79261f7><dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-3 lg:grid-cols-3" data-v-e79261f7><!--[-->`);
...
//# sourceMappingURL=index-a5c4a418.js.map
